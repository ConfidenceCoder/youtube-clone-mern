...
provider.setCustomParameters({
  ...
  const handleGoogleLogin = async (e) => {
    ...
    try {
      ...
      const res = await axios.post(`${API_URLS.AUTH}/googleauth`, {
        name: displayName,
        email,
        img: photoURL,
      },
  ...
  return (
    ...
    <button onClick={handleGoogleLogin} className="w-full flex items-center justify-center gap-3 bg-gray-800 text-white font-medium py-2.5 rounded-md hover:bg-gray-700 transition-colors border border-gray-700">
